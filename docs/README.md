# Switchmap-NG Web Documentation Website

[![N|Solid](static/img/markdown/misc/logo.png)](https://github.com/PalisadoesFoundation/switchmap-ng-web)

# Installation

This document provides instructions on how to set up and start a running instance of switchmap-ng-web website on your local system. The instructions are written to be followed in sequence so make sure to go through each of them step by step without skipping any sections.

# Table of Contents

<!-- /TOC -->

- [Switchmap-NG Web Documentation Website](#switchmap-ng-web-documentation-website)
...
The contents of the `switchmap-ng-web` repo is used to automatically create [the Switchmap-NG Documentation website](https://switchmap-ng-web.talawa.io/). The automation uses [Docusaurus](https://docusaurus.io/docs/), a modern static website generator.
...
```console
$ git clone https://github.com/PalisadoesFoundation/switchmap-ng-web.git
$ cd switchmap-ng-web/docs
$ yarn add docusaurus
```
